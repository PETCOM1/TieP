        ...
        {filteredLessons.map((lesson) => {
          ...
          return (
            <motion.div
              ...
              className={`p-6 rounded-2xl flex flex-col justify-between backdrop-blur-sm group cursor-pointer border transition-all duration-200 ${
                isCompleted 
                  ? 'bg-emerald-950/10 border-emerald-500/20 hover:border-emerald-500/40 shadow-sm shadow-emerald-500/5' 
                  : 'bg-gray-900/40 border-gray-850 hover:border-gray-700/80'
              }`}
            ...
            >
              <div>
                ...
                {/* Key Focus */}
                <div className={`border rounded-xl px-3 py-2 text-xs font-mono mb-4 truncate transition-colors ${
                  isCompleted 
                    ? 'bg-emerald-950/30 border-emerald-900/20 text-emerald-300' 
                    : 'bg-gray-950/60 border-gray-850 text-purple-300/90'
                }`}>
              ...
              <button
                ...
                className={`w-full flex items-center justify-center gap-2 font-bold py-3 rounded-xl text-sm transition-all duration-200 cursor-pointer ${
                  isCompleted 
                    ? 'bg-emerald-900/20 text-emerald-300 border border-emerald-900/30 group-hover:bg-emerald-600 group-hover:text-white group-hover:border-transparent' 
                    : 'bg-gray-800 group-hover:bg-purple-600 text-gray-300 group-hover:text-white'
                }`}
              >
